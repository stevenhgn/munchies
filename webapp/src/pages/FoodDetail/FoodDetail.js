...
import { spacing, palette, typography, sizing, flexbox } from '@material-ui/system';
          ...
          <ButtonArea mb={5}>
            <LinkWrapper to={'/createFood/' + foodId} key={foodId}>
              <ButtonWrapper color="white" mr={5}>
                <StyledButtonPrimary variant="contained" color="inherit" width={100} onClick={editFood}>
                  Edit
                </StyledButtonPrimary>
              </ButtonWrapper>
            </LinkWrapper>

            <StyledButtonDelete variant="contained" color="secondary" width={100} onClick={toggleDialog}>
              Delete
            </StyledButtonDelete>
          </ButtonArea>
        </CardContentWrapper>
      </CardWrapperFlex>
      <Dialog open={open} onClose={toggleDialog} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
        <DialogTitle id="alert-dialog-title">{'Are you sure you want to delete this food?'}</DialogTitle>
